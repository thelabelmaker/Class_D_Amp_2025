...
HD_PWD='/home/ethan/Documents/ee119c/Class_D_Amp_2025/src/class_d_amplifier/class_d_amplifier.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_setup_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source clk_setup_wrapper.tcl -notrace
