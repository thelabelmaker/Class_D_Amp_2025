...
HD_PWD='/home/ethan/Documents/ee119c/Class_D_Amp_2025/src/class_d_amplifier/class_d_amplifier.runs/clk_setup_Quantizer_Interconne_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_setup_Quantizer_Interconne_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_setup_Quantizer_Interconne_0_0.tcl
