...
#
# Script generated by Vivado on Wed May 14 18:56:29 PDT 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : clk_setup.sh
...
#
# Usage        : clk_setup.sh
#                clk_setup.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                clk_setup.sh [-reset_run]
#                clk_setup.sh [-reset_log]
#                clk_setup.sh [-help]
#
...
#                script (type 'clk_setup.sh -help' for more information).
#
...
# script info
echo -e "clk_setup.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./clk_setup.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../class_d_amplifier.gen/sources_1/bd/clk_setup/ipshared/3cbc" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../class_d_amplifier.gen/sources_1/bd/clk_setup/ipshared/3cbc" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.clk_setup xil_defaultlib.glbl -o clk_setup_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./clk_setup_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/ethan/Documents/ee119c/Class_D_Amp_2025/src/class_d_amplifier/class_d_amplifier.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key clk_setup_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc clk_setup_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./clk_setup.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: clk_setup.sh [-help]\n\
Usage: clk_setup.sh [-step]\n\
Usage: clk_setup.sh [-lib_map_path]\n\
Usage: clk_setup.sh [-reset_run]\n\
Usage: clk_setup.sh [-reset_log]\n\
Usage: clk_setup.sh [-keep_index]\n\
Usage: clk_setup.sh [-noclean_files]\n\n\
