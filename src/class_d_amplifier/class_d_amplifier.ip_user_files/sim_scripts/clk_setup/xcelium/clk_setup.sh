...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../class_d_amplifier.gen/sources_1/bd/clk_setup/ipshared/3cbc" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../class_d_amplifier.gen/sources_1/bd/clk_setup/ipshared/3cbc" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.clk_setup xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.clk_setup -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/ethan/Documents/ee119c/Class_D_Amp_2025/src/class_d_amplifier/class_d_amplifier.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log clk_setup_sc.so .tmp_log xcelium_lib waves.shm c.obj)
