...
#
# Script generated by Vivado on Tue Apr 29 11:15:05 PDT 2025
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../ipstatic/ipshared/3cbc" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../ipstatic/ipshared/3cbc" \
